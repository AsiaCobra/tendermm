        ...
        class ReduxFramework {
            ...
            public function show( $opt_name, $default = '' ) {
                ...
                if ( ! is_array( $option ) && $option != '' ) {
                    echo wp_keses_post($option);
                } elseif ( $default != '' ) {
                    echo wp_keses_post($this->_get_default( $opt_name, $default ));
                }
            }
            // show()
            ...
            public function _enqueue_output() {
                ...
                if ( ! empty ( $this->typography ) && ! empty ( $this->typography ) && filter_var( $this->args['output'], FILTER_VALIDATE_BOOLEAN ) ) {
                    ...
                    if ( $this->args['async_typography'] && ! empty ( $this->typography ) ) {
                        ...
                        //echo '<link rel="stylesheet" id="options-google-fonts" href="'.$protocol.$typography->makeGoogleWebfontLink( $this->typography ).'&amp;v='.$version.'" type="text/css" media="all" />';
