...
###########################################
	...
	$cart_link_color_bg = (isset($pacz_settings['header_cart_link_color']['bg']) && !empty($pacz_settings['header_cart_link_color']['bg']))? $pacz_settings['header_cart_link_color']['bg'] : 'none';
	$cart_link_color_bghover = (isset($pacz_settings['header_cart_link_color']['bg-hover']) && !empty($pacz_settings['header_cart_link_color']['bg-hover']))? $pacz_settings['header_cart_link_color']['bg-hover'] : 'none';
...
#menu-main .pacz-cart-link{
	color:{$cart_link_color_regular} !important;
...
###########################################
	...
	if (isset($squeeze_sticky_header) && $squeeze_sticky_header) {
		...
		$header_sticky_height = round($logo_height+(($pacz_header_padding) * 1));
	}
