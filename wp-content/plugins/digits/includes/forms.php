...
function digits_forms($values = null, $form_data = '')
{
    ...
    if ($users_can_register == 1 && $is_elem == -1) {
        ...
        <div class="register" <?php if ($page == 2) {
            ...
            <form accept-charset="utf-8" method="post" class="digits_register" action="<?php echo $url; ?>">
                                ...
                                <div class="minput_inner">
                                    <div class="countrycodecontainer secondregistercountrycodecontainer">
                                        <input type="text" name="digregscode2"
                                               ...
                                               value="<?php echo $userCountryCode; ?>" maxlength="6" size="3"
                                               placeholder="<?php echo $userCountryCode; ?>" autocomplete="countrycode"/>
                                    </div>
