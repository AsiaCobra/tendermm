    ...
    jQuery("#digits_setting_update button[type='submit']").on('click', function (e) {
        ...
        if (te == "msg91") {
            if (jQuery("#msg91senderid").val().length < 6) {
                showDigErrorMessage(digsetobj.Invalidmsg91senderid);
                return false;
            }
        }
        ...
        jQuery("." + te + "cred").find("input, textarea").each(function () {
            ...
            if (input.val().length == 0) {
                ...
                showDigNoticeMessage(digsetobj.PleasecompleteyourAPISettings);
                e.preventDefault();
                return false;
        ...
        jQuery("#digits_setting_update").find("input,textarea, select").each(function () {
            ...
            if (value == null || value.length == 0) {
                ...
                input.focus();
                showDigNoticeMessage(digsetobj.PleasecompleteyourSettings);
                e.preventDefault();
                return false;
