...
//preloading extras group callback
...
function perfmatters_print_preload($args) {
    ...
    echo "<div class='perfmatters-input-row-wrapper'>";
        ...
        //add new row
        echo "<a href='#' class='perfmatters-add-input-row' rel='" . $rowCount . "'>" . __('Add New', 'perfmatters') . "</a>";
...
function perfmatters_print_preload_row($rowCount = 0, $line = array()) {
    echo "<div class='perfmatters-input-row'>";
        echo "<input type='text' id='preload-" . $rowCount . "-url' name='perfmatters_extras[preload][" . $rowCount . "][url]' value='" . (isset($line['url']) ? $line['url'] : "") . "' placeholder='/style.css' />";
...
function perfmatters_print_preconnect($args) {
    ...
    echo "<div id='perfmatters-preconnect-wrapper' class='perfmatters-input-row-wrapper'>";
        ...
        //add new row
        echo "<a href='#' id='perfmatters-add-preconnect' class='perfmatters-add-input-row' rel='" . $rowCount . "'>" . __('Add New', 'perfmatters') . "</a>";
