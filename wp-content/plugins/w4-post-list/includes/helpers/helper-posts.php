	...
	**/
	...
	public function list_edit_form_fields( $fields, $options )
	{
		...
		$fields['post_type'] = array(
			...
			'type' 			=> 'checkbox',
			'option' 		=> W4PL_Utils::post_type_options(),
			'input_class'	=> 'w4pl_onchange_lfr'
		);

		// mime type field
		if ($mime_type_options = W4PL_Utils::post_mime_type_options($options['post_type'])) {
		...
		$fields['orderby'] = array(
			...
			'type' 			=> 'select',
			'option' 		=> W4PL_Utils::post_orderby_options( $options['post_type'] ),
		...
		if ('posts' == $options['list_type'] )
		{
			$fields['groupby'] = array(
				...
				'type' 			=> 'select',
				'option' 		=> W4PL_Utils::post_groupby_options($options['post_type']),
				'input_class'	=> 'w4pl_onchange_lfr'
			);
