...
if($scroll == 'true'){
	...
	$scroll_data = 'data-items="'.$desktop_items.'" data-items-768="'.$tab_landscape_items.'" data-items-1024="'.$tab_items.'" data-autoplay="'.$autoplay.'" data-gutter="'.$gutter_space.'" data-autoplay-speed="'.$autoplay_speed.'" data-delay="'.$delay.'" data-loop="'.$item_loop.'" data-arrow="'.$owl_nav.'"';
}else{
	$scroll_class = '';
	$scroll_data = '';
}
