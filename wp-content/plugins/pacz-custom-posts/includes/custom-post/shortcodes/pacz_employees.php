...
*/
    ...
    $output .= '<div id="employees-' . $id . '" class="pacz-employees"><div class="slick-carousel" data-items="'.$desktop_items.'" data-items-1024="'.$tab_landscape_items.'" data-items-768="'.$tab_items.'" data-autoplay="'.$autoplay.'" data-gutter="'.$gutter_space.'" data-autoplay-speed="'.$autoplay_speed.'" data-delay="'.$delay.'" data-loop="'.$item_loop.'" data-arrow="'.$owl_nav.'">';
		...
		while ($loop->have_posts()):
			...
			$output .= '<div class="slide" style="padding:'.$gutter_space.'px;">';
				$output .= $style == 'grid' ? '<div class="pacz-employee-item">' : '<div class="pacz-employee-item">';
					$output .= '<img alt="' . get_the_title() . '" style="'.$image_width.'" title="' . get_the_title() . '" src="' . bfi_thumb($image_src, $param) . '" />';
					if($hover_style == 1){
							$output .= '<div class="hover_style1 hover-overlay">';
								$output .= '<div class="team-info-wrapper">';
									$output .= '<div class="team-info-holder">';
					...
					if($hover_style == 2){
							$output .= '<div class="hover_style2 team-info-wrapper">';
								$output .= '<div class="team-info-holder">';
									$output .= '<span class="team-member-name">' . get_the_title() . '</span>';
									$output .= '<span class="team-member-position">' . get_post_meta(get_the_ID(), '_position', true) . '</span>';
									if ($dimension > 200) {
