...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'align' ); ?>"><?php _e('Align:', 'pacz'); ?></label>
		...
		<div id="pacz-social-custom-skin">
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'icon_color' ); ?>"><?php _e('Icon Color:', 'pacz'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'icon_hover_color' ); ?>"><?php _e('Icon Hover Color:', 'pacz'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'icon_border_color' ); ?>"><?php _e('Icon Border Color:', 'pacz'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'icon_bg_main_color' ); ?>"><?php _e('Icon Background Color:', 'pacz'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'icon_bg_color' ); ?>"><?php _e('Icon Hover Background Color:', 'pacz'); ?></label>
