						...
						<li class="alsp-list-group-item">
							...
							<a class="alsp-hint-icon" href="javascript:void(0);" data-content="<?php echo esc_attr('
								<div class="alsp-panel alsp-panel-default alsp-text-center alsp-choose-plan">
									...
									' . alsp_renderTemplate(array(ALSP_FSUBMIT_TEMPLATES_PATH, 'package_details.tpl.php'), array('args' => array('show_period' => 0,'show_sticky' => 1,'show_featured' => 1,'show_categories' => 1,'show_locations' => 1,'show_maps' => 1,'show_images' => 1,'show_videos' => 1,'columns_same_height' => 1,), 'level' => $alsp_level), true) . '
									</ul>
