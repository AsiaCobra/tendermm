...
<a href="<?php echo alsp_dashboardUrl(array('alsp_action' => 'process_claim', 'listing_id' => $alsp_instance->current_listing->post->ID, 'claim_action' => 'approve', 'referer' => urlencode($public_control->referer))); ?>" class="btn btn-primary"><?php _e('Approve', 'ALSP'); ?></a>
&nbsp;&nbsp;&nbsp;
<a href="<?php echo alsp_dashboardUrl(array('alsp_action' => 'process_claim', 'listing_id' => $alsp_instance->current_listing->post->ID, 'claim_action' => 'decline', 'referer' => urlencode($public_control->referer))); ?>" class="btn btn-primary"><?php _e('Decline', 'ALSP'); ?></a>
&nbsp;&nbsp;&nbsp;
<a href="<?php echo $public_control->referer; ?>" class="btn btn-primary"><?php _e('Cancel', 'ALSP'); ?></a>
<?php elseif ($public_control->action == 'processed'): ?>
