...
<a href="<?php echo alsp_dashboardUrl(array('alsp_action' => 'renew_listing', 'listing_id' => $alsp_instance->current_listing->post->ID, 'renew_action' => 'renew', 'referer' => urlencode($public_control->referer))); ?>" class="btn btn-primary"><?php _e('Renew listing', 'ALSP'); ?></a>
&nbsp;&nbsp;&nbsp;
<a href="<?php echo $public_control->referer; ?>" class="btn btn-primary"><?php _e('Cancel', 'ALSP'); ?></a>
<?php elseif ($public_control->action == 'renew'): ?>
