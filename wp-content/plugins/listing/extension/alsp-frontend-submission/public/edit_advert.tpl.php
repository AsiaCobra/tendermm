...
<div class="alsp-submit-listing-wrap row clearfix">
	<div class="edit-listing cz-creat-listing col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="cz-creat-listing-inner clearfix">
			<?php alsp_renderMessages(); ?>
			<div class="submit_heading"><?php echo sprintf(__('Edit listing "%s"', 'ALSP'), $alsp_instance->current_listing->title()); ?></div>
			...
			<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="alsp-submit-section">
							...
							<div class="alsp-submit-section-inside field-wrapper">
								...
								<?php if ($alsp_instance->current_listing->level->allow_resurva_booking): ?>
									<div class="field-wrap">
									<p class="alsp-submit-section-label alsp-submit-field-title"><?php echo _e('Add Resurva Booking Url', 'ALSP'); ?></p>
				...
				<?php submit_button(__('Update Tender', 'ALSP'), 'btn')?>
			</form>
		</div>
	</div>
</div>