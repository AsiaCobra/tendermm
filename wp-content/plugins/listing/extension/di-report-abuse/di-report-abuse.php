        ...
        <form class="report-post-form" id="report-post-form">
			...
			<div>
                <p><?php echo esc_html__('Why are you Reporting?', 'ALSP'); ?></p>
					<label>
						<input type="radio" name="report_post_reason" id="report_post_reason1" class="report-post-control" value="<?php echo esc_html__('This is illegal/fraudulent', 'ALSP');  ?>" />
						<?php echo esc_html__('This is illegal/fraudulent', 'ALSP');  ?>
						<span class="radio-check-item"></span>
					</label>
					<label>
						<input type="radio" name="report_post_reason" id="report_post_reason2" class="report-post-control" value="<?php echo esc_html__('This ad is spam', 'ALSP');  ?>" />
						<span class="radio-check-item"></span>
						<?php echo esc_html__('This ad is spam', 'ALSP');  ?>
					</label>
					<label>
						<input type="radio" name="report_post_reason" id="report_post_reason3" class="report-post-control" value="<?php echo esc_html__('This ad is a duplicate', 'ALSP');  ?>" />
						<span class="radio-check-item"></span>
						<?php echo esc_html__('This ad is a duplicate', 'ALSP');  ?>
					</label>
					<label>
						<input type="radio" name="report_post_reason" id="report_post_reason4" class="report-post-control" value="<?php echo esc_html__('This ad is in the wrong category', 'ALSP');  ?>" />
						<span class="radio-check-item"></span>
						<?php echo esc_html__('This ad is in the wrong category', 'ALSP');  ?>
					</label>
					<label>
						<input type="radio" name="report_post_reason" id="report_post_reason5" class="report-post-control" value="<?php echo esc_html__('The ad goes against posting rules', 'ALSP');  ?>" />
						<span class="radio-check-item"></span>
...
<?php
    ...
    function admin_menu()
    {
		if (defined('PACZ_THEME_SETTINGS')) {
			add_submenu_page( PACZ_THEME_SETTINGS,__('Report Abused', 'ALSP'), __('Report Abused', 'ALSP'), 'edit_others_posts', 'di-report-abused', array($this, 'reported_posts'), 'dashicons-megaphone' );
