...
class alsp_content_field_website extends alsp_content_field {
	...
	public function configure() {
		...
		if (alsp_getValue($_POST, 'submit') && wp_verify_nonce($_POST['alsp_configure_content_fields_nonce'], ALSP_PATH)) {
			...
			if ($validation->run()) {
				...
				alsp_renderTemplate('alsp_fields/fields/alsp_website_configuration.tpl.php', array('content_field' => $this));
			}
		} else
			alsp_renderTemplate('alsp_fields/fields/alsp_website_configuration.tpl.php', array('content_field' => $this));
	}
	...
	public function renderInput() {
		...
		if (!($template = alsp_isTemplate('alsp_fields/fields/alsp_website_input_'.$this->id.'.tpl.php'))) {
			$template = 'alsp_fields/fields/alsp_website_input.tpl.php';
		}
	...
	public function renderOutput($listing = null) {
		if (!($template = alsp_isTemplate('alsp_fields/fields/alsp_website_output_'.$this->id.'.tpl.php'))) {
			$template = 'alsp_fields/fields/alsp_website_output.tpl.php';
		}
	...
	public function renderOutputForMap($location, $listing) {
		return alsp_renderTemplate('alsp_fields/fields/alsp_website_output_map.tpl.php', array('content_field' => $this, 'listing' => $listing), true);
	}
}
?>