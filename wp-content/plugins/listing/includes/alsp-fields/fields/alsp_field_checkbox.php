...
class alsp_content_field_checkbox extends alsp_content_field_select {
	...
	public function renderInput() {
		if (!($template = alsp_isTemplate('alsp_fields/fields/alsp_checkbox_input_'.$this->id.'.tpl.php'))) {
			$template = 'alsp_fields/fields/alsp_checkbox_input.tpl.php';
		}
	...
	public function renderOutput($listing = null) {
		if (!($template = alsp_isTemplate('alsp_fields/fields/alsp_checkbox_output_'.$this->id.'.tpl.php'))) {
			$template = 'alsp_fields/fields/alsp_checkbox_output.tpl.php';
		}
	...
	public function renderOutputForMap($location, $listing) {
		return alsp_renderTemplate('alsp_fields/fields/alsp_checkbox_output_map.tpl.php', array('content_field' => $this, 'listing' => $listing), true);
	}
}
?>