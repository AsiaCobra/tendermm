...
class alsp_content_field_textarea extends alsp_content_field {
	...
	public function configure() {
		...
		if (alsp_getValue($_POST, 'submit') && wp_verify_nonce($_POST['alsp_configure_content_fields_nonce'], ALSP_PATH)) {
			...
			if ($validation->run()) {
				...
				alsp_renderTemplate('alsp_fields/fields/alsp_textarea_configuration.tpl.php', array('content_field' => $this));
			}
		} else
			alsp_renderTemplate('alsp_fields/fields/alsp_textarea_configuration.tpl.php', array('content_field' => $this));
	}
	...
	public function renderInput() {
		if (!($template = alsp_isTemplate('alsp_fields/fields/alsp_textarea_input_'.$this->id.'.tpl.php'))) {
			$template = 'alsp_fields/fields/alsp_textarea_input.tpl.php';
		}
	...
	public function renderOutput($listing = null) {
		...
		if (!($template = alsp_isTemplate('alsp_fields/fields/alsp_textarea_output_'.$this->id.'.tpl.php'))) {
			$template = 'alsp_fields/fields/alsp_textarea_output.tpl.php';
		}
