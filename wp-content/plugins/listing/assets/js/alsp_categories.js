(function($) {
	...
	$(function() {
		...
		$('ul.alsp-categorychecklist li:not(.active) ul').each(function() {
			$(this).hide();
		});
		...
		$(".submit-cat-hide-expand .alsp-expand-terms").click(function() {
			$('.alsp-categories-tree-panel ul.alsp-categorychecklist li.parent').each(function() {
				$(this).addClass('active');
				$(this).children('ul').slideDown('fast');
			});
		});
		$(".submit-cat-hide-expand .alsp-collapse-terms").click(function() {
			$('.alsp-categories-tree-panel  ul.alsp-categorychecklist li.parent').each(function() {
