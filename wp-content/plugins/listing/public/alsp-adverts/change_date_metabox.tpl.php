...
<?php if (!$ALSP_ADIMN_SETTINGS['alsp_change_expiration_date'] && current_user_can('manage_options')): ?>
<p><?php _e("Regular users can not change expiration date. This option is available only for admins.", 'ALSP'); ?></p>
<?php endif; ?>
...
<div class="alsp-content alsp-content-fields-metabox">
	<div class="alsp-field alsp-form-group alsp-form-horizontal">
		<label class="alsp-col-md-1 alsp-control-label">
			<?php _e('Date:', 'ALSP'); ?>
		</label>
		<div class="alsp-col-md-3">
		...
		<label class="alsp-col-md-1 alsp-control-label"><?php _e('Time:', 'ALSP'); ?></label>
		<div class="alsp-col-md-3">
