<?php global $ALSP_ADIMN_SETTINGS; ?>
	...
	<div class="alsp-location-in-metabox-wrap clearfix">
		<div class="alsp-location-in-metabox clearfix">
			...
			<div class="location-input alsp-location-input alsp-address-line-1-wrapper" <?php if (!$ALSP_ADIMN_SETTINGS['alsp_enable_address_line_1']): ?>style="display: none;"<?php endif; ?>>
				<label class="alsp-control-label alsp-submit-field-title">
					<?php
						if (!$ALSP_ADIMN_SETTINGS['alsp_enable_address_line_2'])
							_e('Address', 'ALSP');
						else
							_e('Address line 1', 'ALSP');
						?>
				</label>
			...
			<div class="location-input alsp-location-input alsp-address-line-2-wrapper" <?php if (!$ALSP_ADIMN_SETTINGS['alsp_enable_address_line_2']): ?>style="display: none;"<?php endif; ?>>
				<label class="alsp-control-label alsp-submit-field-title">
			...
			<div class="location-input alsp-location-input alsp-zip-or-postal-index-wrapper" <?php if (!$ALSP_ADIMN_SETTINGS['alsp_enable_postal_index']): ?>style="display: none;"<?php endif; ?>>
				<label class="alsp-control-label alsp-submit-field-title">
			...
			<div class="location-input alsp-location-input alsp-additional-info-wrapper" <?php if (!$ALSP_ADIMN_SETTINGS['alsp_enable_additional_info']): ?>style="display: none;"<?php endif; ?>>
				<label class=" alsp-control-label alsp-submit-field-title">
			...
			<?php if ($listing->level->map): ?>
				<div class="row clearfix">
					<div class="col-md-6 alsp-manual-coords-wrapper clearfix" <?php if (!$ALSP_ADIMN_SETTINGS['alsp_enable_manual_coords']): ?>style="display: none;"<?php endif; ?>>
					...
					<?php if ($listing->level->map_markers): ?>
						<div class="col-md-6">
							<div class="alsp-location-input input-market">
