				...
				<div class="pacz-box-content wp-clearfix">
					...
					(function($) {
						...
						$(function() {
							...
							$("body").on("click", "#unlimited_listingtype", function() {
								if ($("#unlimited_listingtype").is(':checked')) {
									$("#listingtype_number").attr('disabled', true);
								} else {
									$("#listingtype_number").removeAttr('disabled');
								}
							});
						});
					})(jQuery);
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<p class="description"><?php _e("Describe this level advantages and options as much easier for users as you can", 'ALSP'); ?></p>
										<?php alsp_wpmlTranslationCompleteNotice(); ?>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										...
										<p class="description">
											<?php _e("After expiration listing will change level automatically.", 'ALSP'); ?>
										</p>
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<p class="description"><?php _e("Enter more than 1 to allow users get packages of listings. Users will be able to use listings from their package to renew, raise up and upgrade existing listings.", 'ALSP'); ?></p>
									</td>
								</tr>
								<tr>
									<th scope="row">
								...
								<tr>
									...
									<td>
										...
										<p class="description"><?php _e("Listings of this level will be on top", 'ALSP'); ?></p>
									</td>
								</tr>
								<tr>
									<th scope="row">
									...
									<td>
										...
										<p class="description"><?php _e("Listings of this level will be on top and marked as featured", 'ALSP'); ?></p>
									</td>
								</tr>
								<tr>
									<th scope="row">
									...
									<td>
										...
										<p class="description"><?php _e("When unchecked - listings info will be shown only on excerpt pages, without links to detailed pages.", 'ALSP'); ?></p>
									</td>
								</tr>
								<tr>
									<th scope="row">
								...
								<tr>
									<th scope="row">
										<label><?php _e('Enable map', 'ALSP'); ?></label>
									</th>
									<td>
										<input
											name="map"
								...
								<tr>
									<th scope="row">
										<label><?php _e('Enable listing logo on excerpt pages', 'ALSP'); ?></label>
									</th>
									<td>
										<input
											name="logo_enabled"
								...
								<tr>
									<th scope="row">
										<label><?php _e('Custom markers on the map', 'ALSP'); ?></label>
									</th>
									<td>
										<input
											name="map_markers"
								...
								<tr>
									...
									<td>
										...
										<?php alsp_termsSelectList('categories', ALSP_CATEGORIES_TAX, $level->categories); ?>
									</td>
								</tr>
								<tr>
									<th scope="row">
										<label><?php _e('Listing Types number available', 'ALSP'); ?></label>
									</th>
									<td>
										<input
											name="listingtype_number"
											id="listingtype_number"
											type="text"
											size="1"
											value="<?php echo esc_attr($level->listingtype_number); ?>"
											<?php disabled($level->unlimited_listingtype); ?> />

										<input
											name="unlimited_listingtype"
											id="unlimited_listingtype"
											type="checkbox"
											value="1"
											<?php checked($level->unlimited_listingtype); ?> />
										<?php _e('unlimited listingtype', 'ALSP'); ?>
									</td>
								</tr>
								<tr>
									<th scope="row">
									...
									<td>
										<p class="description"><?php _e('You may define some special Listing Types, those would be available for this level', 'ALSP'); ?></p>
										<?php alsp_termsSelectList('listingtypes', ALSP_TYPE_TAX, $level->listingtypes); ?>
									</td>
								</tr>
								<tr>
									<th scope="row">
									...
									<td>
										...
										<?php alsp_termsSelectList('locations', ALSP_LOCATIONS_TAX, $level->locations); ?>
									</td>
								</tr>
								<tr>
									<th scope="row">
									...
									<td>
										...
										<select multiple="multiple" name="content_fields[]" class="selected_terms_list form-control form-group" style="height: 300px">
										<option value="" <?php echo (!$level->content_fields) ? 'selected' : ''; ?>><?php _e('- Select All -', 'ALSP'); ?></option>
										<option value="0" <?php echo ($level->content_fields == array(0)) ? 'selected' : ''; ?>><?php _e('- No fields -', 'ALSP'); ?></option>
										<?php foreach ($content_fields AS $field): ?>
										<?php if (!$field->is_core_field): ?>
										<option value="<?php echo $field->id; ?>" <?php echo (in_array($field->id, $level->content_fields)) ? 'selected' : ''; ?>><?php echo $field->name; ?></option>
