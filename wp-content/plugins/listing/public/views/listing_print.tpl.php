...
$public_control = new alsp_directory_controller();
$public_control->init();
$alsp_instance->public_controls['alsp'][] = $public_control;
$alsp_instance->_public_controls['alsp'][] = $public_control;
	...
	<div id="page" class="site alsp-content">
		<div id="main" class="wrapper">
			...
			<?php while ($public_control->query->have_posts()): ?>
				...
				<?php $listing->renderMap($public_control->hash, false, true); ?>
				<?php endif; ?>
