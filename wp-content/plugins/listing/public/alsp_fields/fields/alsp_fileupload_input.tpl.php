<div class="alsp-form-group alsp-field alsp-field-input-block alsp-field-input-block-<?php echo $content_field->id; ?>">
	...
	<div class="alsp-col-md-10">
		<div class="alsp-row">
			<?php if ($file): ?>
			<div class="alsp-col-md-6">
			...
			<div class="alsp-col-md-12">
				...
				<input type="text" name="alsp-field-input-text-<?php echo $content_field->id; ?>" class="alsp-field-input-text form-control regular-text" value="<?php echo esc_attr($content_field->value['text']); ?>" />
			</div>
			<?php endif; ?>
		</div>
