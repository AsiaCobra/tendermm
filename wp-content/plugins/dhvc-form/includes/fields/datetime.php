...
function dhvc_form_field_datetime_validation_filter($result, $field){
	...
	elseif (''!=$value && 'time'!==$field->attr('type') && !dhvc_form_is_date($value))
...
function dhvc_form_field_datetime_params(){
	return array(
	    ...
	    "params" => array(
	    	...
	    	array(
	    		"type" => "textfield",
	    		"heading" => __("Range Start by field", 'dhvc-form'),
	    		...
	    		"description" => __('Enter field name you want set it is start date or time for this field', 'dhvc-form')
	    	),
	        array(
	            "type" => "textfield",
