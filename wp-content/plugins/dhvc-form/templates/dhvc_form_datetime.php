...
$output .= '<input '.$value.' readonly '.('date'===$type && !empty($range_field) ? ' data-range_field_set_value="'.apply_filters('dhvc_form_datepicker_range_field_set_value', 'yes').'" data-range_field_start_current="'.apply_filters('dhvc_form_datepicker_range_field_start_current', 1).'" data-range_field="'.$range_field.'" ' : '').' data-field-name="'.$name.'" type="text" id="dhvc_form_control_'.$name.'" '.$picker_attrs.' name="'.$name.'" '
