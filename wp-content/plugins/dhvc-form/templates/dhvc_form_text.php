...
$output .= '<input data-field-name="'.$name.'" autocomplete="off" type="'.$field_type.'" id="dhvc_form_control_'.$name.'" name="'.$name.'" value="'.$default_value.'" '.(!empty($minlength) ? ' minlength="'.$minlength.'"' : '').' '.(!empty($maxlength) ? ' maxlength="'.$maxlength.'"' : '')
