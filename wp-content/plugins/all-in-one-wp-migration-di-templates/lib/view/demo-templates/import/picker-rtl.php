<div id="ai1wmdi-import-modal-rtl" class="ai1wmdi-modal ai1wm-not-visible">
	<div class="ai1wm-modal-action">
		...
		<p>
			...
			<button type="button" class="ai1wmdi-import-url-rtl ai1wm-button-green" id="ai1wmdi-import-url-rtl" value="https://assets.designinvento.net/classiads-auth/files/classiads-rtl.wpress" v-on="click: select" /><?php _e( 'Confirm', AI1WMDI_PLUGIN_NAME ); ?></button>
